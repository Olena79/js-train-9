...
function findLastEvenNumber(arr) {
  ...
  const findLast = arr.findLast((element) => element % 2 === 0);

  return findLast !== undefined ? findLast : "Парних чисел не знайдено";
...
function getSubArrayAndConvertToString(arr, startIdx) {
  ...
  const getSubArray = arr.slice(startIdx);
  const convertToString = getSubArray.join(", ");
...
function getArrayKeys(arr) {
  ...
  const getFrom = Array.from(getKeys);
  return getFrom;
  // Перевіряємо, чи вхідний параметр є масивом, якщо ні повертаємо 'Вхідний параметр має бути масивом'
...
function getPositiveArrayValues(arr) {
  ...
  const getValues = Array.from(arr.values());
  const getFilter = getValues.filter((num) => num > 0);
  return getFilter;
  // Перевіряємо, чи вхідний параметр є масивом, якщо ні повертаємо 'Вхідний параметр має бути масивом'
...
function sumAndPrint(arr) {
  ...
  const sum = arr.reduce((each, num) => each + num, 0);
...
function flattenSquareAndFilter(arr, threshold) {
  ...
  const getFlat = arr.flat();
  const getMap = getFlat.map((el) => el ** 2);
  const getFilter = getMap.filter((num) => num > threshold);
  return getFilter;
  // Перевіряємо, чи вхідний параметр є масивом, якщо ні повертаємо 'Вхідний параметр має бути масивом'
...
function getLastElementsSumAndPrint(arr, n) {
  ...
  const sum = lastElements.reduceRight((fst, secd) => fst + secd, 0);
...
function wordLengths(arr) {
  ...
  const getLength = arr.map((elem) => elem.length);
  return getLength;
  // Перевіряємо, чи вхідний параметр є масивом, якщо ні, повертаємо 'Вхідний параметр має бути масивом'
...
function findDuplicateElements(arr) {
  ...
  const double = arr.filter((element, index) => {
...
function calculateTotalPrice(arr) {
  ...
  const startSum = 0;
  const totalPrice = arr.reduce((num, sum) => num + sum.price, startSum);
  return totalPrice;
...
function findLastNegativeNumberIndex(arr) {
  ...
  const array1 = arr.findLastIndex((num) => num < 0);
  return array1;
  // Перевіряємо, чи вхідний параметр є масивом, якщо ні, повертаємо -1
